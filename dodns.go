...
func get_ip_from(urlString string) (error, net.IP) {

	url, err := url.Parse(urlString)
	if err != nil {
		return fmt.Errorf("Provided url string [ %s ] can not be parsed: %v", urlString, err), nil
	}
...
func check_domain_valid(dom string) error {
...
func check_record_valid(record string, domain string) error {

	err := check_domain_valid(domain)
	if err != nil {
...
func main() {
	...
	err = check_record_valid(record, domain)
